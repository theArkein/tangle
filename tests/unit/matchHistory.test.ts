...
beforeAll(async () => {
  ...
  await typedEnv.DB.exec(
    "CREATE TABLE IF NOT EXISTS matches (id TEXT PRIMARY KEY, player1_id TEXT NOT NULL, player2_id TEXT NOT NULL, winner_id TEXT, round_scores TEXT NOT NULL, created_at INTEGER NOT NULL, game_mode TEXT NOT NULL DEFAULT 'classic')"
  );
  await typedEnv.DB.exec(
